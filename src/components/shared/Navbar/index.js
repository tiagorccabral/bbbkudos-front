                    ...
                    <Navbar className="justify-content-between" expand="md">
                        ...
                        <Navbar.Collapse className="justify-content-end mr-sm-2">
                            <Nav className="mr-auto">
                                <Nav.Link>|</Nav.Link>
                                <Nav.Link href="/kudos-board">
                                    <NavLinkText
                                        underline={!isEmpty(location) && location.pathname === "/kudos-board" ? "underline" : ""}>
                                        Dê um kudo
                                    </NavLinkText>
                                </Nav.Link>
                                <Nav.Link href="/timeline">
                                    <NavLinkText
                                        underline={!isEmpty(location) && location.pathname === "/timeline" ? "underline" : ""}>
                                        Timeline
                                    </NavLinkText>
                                </Nav.Link>
                                <Nav.Link href="/my-kudos">
                                    <NavLinkText
                                        underline={!isEmpty(location) && location.pathname === "/my-kudos" ? "underline" : ""}>
                                        Meus kudos
                                    </NavLinkText>
                                </Nav.Link>
                            </Nav>
                            ...
                            />
                            <Navbar.Text>
                                <NavLinkText>{auth.user.name}</NavLinkText>
                            </Navbar.Text>
                            <Navbar.Text>
                                <Button
                                    className="mr-2"
...
export default withRouter(connect(mapStateToProps, {logoutUser})(NavbarComponent));
